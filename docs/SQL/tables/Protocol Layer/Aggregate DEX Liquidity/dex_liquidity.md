...
The `dex_liquidity` table provides indexed views of all DEX liquidity for a specified chain. All DEX liquidity tables follows the same database schema presented below.
...
| lp_address | The contract address of the liquidity pool. | `text` |
