...
The `ethereum.dex_liquidity` table provides indexed views of all DEX liquidity on ethereum. All DEX liquidity tables follows the same database schema presented below.
