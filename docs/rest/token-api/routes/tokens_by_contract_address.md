...
This endpoint returns all [Tokens](../models/token_model.md) for a given list of contract addresses. Supported chains: `ethereum`, `polygon`, `goerli`, `scroll`, `arbitrum`, `base`.
