...
The `ethereum.dex_swaps` table provides indexed views of all DEX swaps transacted on Ethereum. All DEX swaps tables follows the same database schema presented below.
