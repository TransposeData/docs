...
The `ethereum.dex_pools` table provides indexed views of all DEX pools created on Ethereum. All DEX pools tables follows the same database schema presented below.
